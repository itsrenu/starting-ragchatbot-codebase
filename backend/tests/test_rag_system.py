...
class TestRAGSystem:
    ...
    def setup_method(self, mock_tool_manager, mock_outline_tool, mock_search_tool, 
    ...
    def test_initialization(self):
        ...
        self.mock_tool_manager_instance.register_tool.assert_any_call(self.mock_search_tool_instance)
        self.mock_tool_manager_instance.register_tool.assert_any_call(self.mock_outline_tool_instance)
    ...
    def test_query_without_session(self):
        ...
        self.mock_tool_manager_instance.get_tool_definitions.return_value = [{"name": "test_tool"}]
    ...
    def test_query_with_session(self):
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "AI response with history"
    ...
    def test_query_with_ai_generator_error(self):
        ...
        self.mock_ai_generator_instance.generate_response.side_effect = Exception("API key not found")
    ...
    def test_query_tool_integration(self):
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "Python is a programming language used for..."
